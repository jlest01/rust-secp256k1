...
use secp256k1::musig::{
    ...
    MusigSession, MusigSessionSecRand,
};
...
fn main() {
    ...
    let musig_session_sec_rand1 = MusigSessionSecRand::from_rng(&mut rng);
    ...
    let musig_session_sec_rand2 = MusigSessionSecRand::from_rng(&mut rng);
