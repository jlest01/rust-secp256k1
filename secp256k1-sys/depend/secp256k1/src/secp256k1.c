...
static rustsecp256k1_v0_10_0_scratch_space* rustsecp256k1_v0_10_0_scratch_space_create(const rustsecp256k1_v0_10_0_context* ctx, size_t max_size) {
    VERIFY_CHECK(ctx != NULL);
    return rustsecp256k1_v0_10_0_scratch_create(&ctx->error_callback, max_size);
}

static void rustsecp256k1_v0_10_0_scratch_space_destroy(const rustsecp256k1_v0_10_0_context *ctx, rustsecp256k1_v0_10_0_scratch_space* scratch) {
    VERIFY_CHECK(ctx != NULL);
