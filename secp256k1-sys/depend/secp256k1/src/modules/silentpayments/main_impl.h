...
static int rustsecp256k1_v0_10_0_silentpayments_create_output_pubkey(const rustsecp256k1_v0_10_0_context *ctx, rustsecp256k1_v0_10_0_xonly_pubkey *P_output_xonly, const unsigned char *shared_secret33, const rustsecp256k1_v0_10_0_pubkey *recipient_spend_pubkey, unsigned int k) {
    ...
    rustsecp256k1_v0_10_0_pubkey_load(ctx, &P_output_ge, recipient_spend_pubkey);
...
int rustsecp256k1_v0_10_0_silentpayments_test_outputs(
    ...
    for (i = 0; i < n_recipients; i++) {
        rustsecp256k1_v0_10_0_xonly_pubkey new_xonly_pubkey;
        ret = rustsecp256k1_v0_10_0_xonly_pubkey_from_pubkey(ctx, &new_xonly_pubkey, NULL, &recipients[i]->scan_pubkey);
        if (!ret) {
            return 0;
        }
    ...
    for (i = 0; i < n_taproot_seckeys; i++) {
        ret = rustsecp256k1_v0_10_0_keypair_xonly_pub(ctx, &taproot_outputs[i], NULL, taproot_seckeys[i]);
        if (!ret) {
            return 0;
        }
    }
    ...
    for (i = 0; i < n_plain_seckeys; i++) {
        ret = rustsecp256k1_v0_10_0_ec_pubkey_create(ctx, &plain_outputs[i], plain_seckeys[i]);
        if (!ret) {
            return 0;
        }
    }
...
int rustsecp256k1_v0_10_0_silentpayments_recipient_create_labelled_spend_pubkey(const rustsecp256k1_v0_10_0_context *ctx, rustsecp256k1_v0_10_0_pubkey *labelled_spend_pubkey, const rustsecp256k1_v0_10_0_pubkey *recipient_spend_pubkey, const rustsecp256k1_v0_10_0_pubkey *label) {
    ...
    rustsecp256k1_v0_10_0_pubkey_load(ctx, &B_m, recipient_spend_pubkey);
    rustsecp256k1_v0_10_0_pubkey_load(ctx, &label_addend, label);
...
int rustsecp256k1_v0_10_0_silentpayments_recipient_scan_outputs(
    ...
    rustsecp256k1_v0_10_0_pubkey_load(ctx, &recipient_spend_pubkey_ge, recipient_spend_pubkey);
